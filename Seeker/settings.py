...
SECRET_KEY = '-0$gx)(r(r-m4=8%##cz^^92&u3#h*e@71^=4v^2id^l(dkkqj'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','167.172.237.157']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'seekerdb',
        'USER':'postgres',
        'PASSWORD': 'seekerLargescale',
        'HOST': 'seekdb.c7diiqilawvm.us-east-2.rds.amazonaws.com',
        'PORT': '5432',
    }
}
